...
export const metadata = {
  title: "Login",
  description:
    "Log in to your Carely account to manage bookings and find your perfect caregiver.",
};
  ...
  return (
    <>
      <main className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        {/* Left – brand panel */}
        <div className="bg-brand-gradient relative overflow-hidden hidden lg:flex items-center px-16 py-24">
          ...
          <div className="relative z-10 max-w-md">
            ...
            >
              <span
                className="w-10 h-10 bg-white/15 border-2 border-white/30 rounded-[12px]
                               flex items-center justify-center font-jakarta font-extrabold
                               text-xl text-white"
              >
                C
              </span>
            ...
            <div className="flex flex-col gap-3.5 mb-10">
              {[
                { icon: "verified", text: "5,000+ verified caregivers" },
            ...
            <div className="bg-white/10 border border-white/15 rounded-2xl p-6">
              <p className="text-white/90 italic leading-relaxed mb-4 text-[0.9375rem]">
                "Carely made finding care for my mother effortless. Truly
                exceptional."
              </p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60 text-xs">Daughter of client</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <form className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                  ...
                  <a
                    href="#"
                    className="text-xs text-[#224bdd] font-semibold no-underline hover:opacity-75"
                  >
                    Forgot Password?
                  </a>
                </div>
